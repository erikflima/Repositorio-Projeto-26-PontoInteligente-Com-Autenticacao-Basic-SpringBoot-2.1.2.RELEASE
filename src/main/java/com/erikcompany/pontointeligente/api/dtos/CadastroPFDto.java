...
public class CadastroPFDto {
	...
	private Optional<String> valorHora           = Optional.empty(); //Campo Opcional
	
	private Optional<String> qtdHorasTrabalhoDia = Optional.empty(); //Campo Opcional
	 
	private Optional<String> qtdHorasAlmoco      = Optional.empty(); //Campo Opcional
